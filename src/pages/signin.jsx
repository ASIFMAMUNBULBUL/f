...
class Signin extends React.Component {
  constructor(props) {
    ...
    this.state = { err_confirmpassword: String };
  }
      ...
      <div>
        <div className="container-fluid px-3">
          <div className="row min-vh-100">
            ...
            <button className="btn btn btn-outline-primary btn-block btn-social mb-3"><i className="fa-2x fa-facebook-f fab btn-social-icon"> </i><span className="d-none d-sm-inline">with Facebook</span></button>
            <button className="btn btn btn-outline-muted btn-block btn-social mb-3"><i className="fa-2x fa-google fab btn-social-icon"> </i> <span className="d-none d-sm-inline">with Google</span></button>
