...
class AddStepZero extends React.Component{
     render() {
          return (
               <div>
                    <Header/>
               ...
               <div className="container">
                    ...
                    <div className="col-lg-5">
                         ...
                         <p className="mb-5 mb-lg-0"> <a className="btn btn-primary" href="addpropertystep1">Add your listing</a></p>
                    </div>
                    <div className="col-lg-5 ml-auto d-flex align-items-center"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/directory/1-5/img/illustration/undraw_celebration_0jvk.svg" alt style={{width: 400}} /></div>
                    </div>
               </div>
                    </section>
                    <Footer/>
