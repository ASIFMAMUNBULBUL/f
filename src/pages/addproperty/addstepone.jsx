    ...
    <div className="container">
      ...
      <form>
          ...
          <div className="col-lg-7 ml-auto">
            ...
            <div className="form-group">
              ...
              <div className="custom-control custom-radio">
                ...
                <label className="custom-control-label" htmlFor="guests_0">Yes, it's primarily set up for guests</label>
              </div>
              <div className="custom-control custom-radio">
                <input className="custom-control-input" type="radio" id="guests_1" name="guests" />
                <label className="custom-control-label" htmlFor="guests_1">No, I keep my personal belongings there</label>
              </div>
            </div>
          </div>
        </div>
        <div className="row form-block">
          ...
          <div className="col-lg-7 ml-auto">
            ...
            <div className="form-group">
              ...
              <select className="selectpicker form-control" name="country" id="form_country" data-style="btn-selectpicker" title=" " data-live-search="true">
        ...
        <div className="row form-block flex-column flex-sm-row">
          ...
          <div className="col text-center text-sm-right"><a className="btn btn-primary px-3" href="addpropertystep2"> Next step<i className="fa-chevron-right fa ml-2" /></a></div>
        </div>
      </form>
    </div>
              </section>
