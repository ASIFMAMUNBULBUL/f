        ...
        <div className="row">
          <div className="col-lg-3 mr-lg-auto">
            <div className="card border-0 shadow mb-6 mb-lg-0">
                          <div className="card-header bg-gray-100 py-4 border-0 text-center"><a className="d-inline-block" href="#"><img className="d-block avatar avatar-xxl p-2 mb-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-10.jpg"} alt /></a>
                <h5>Jack London</h5>
          ...
          <div className="col-lg-9 pl-lg-5">
            ...
            <div className="text-block">
              ...
              <div className="row">
                {/* place item*/}
                <div className="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
                  <div className="card h-100 border-0 shadow">
                      ...
                      <div className="card-img-overlay-bottom z-index-20">
                                    <div className="media text-white text-sm align-items-center"><img className="avatar avatar-border-white mr-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-0.jpg"} alt="Pamela" />
                ...
                {/* place item*/}
                <div className="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e322f3375db4d89128">
                  <div className="card h-100 border-0 shadow">
                      ...
                      <div className="card-img-overlay-bottom z-index-20">
                                    <div className="media text-white text-sm align-items-center"><img className="avatar avatar-border-white mr-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-7.jpg"} alt="John" />
                ...
                {/* place item*/}
                <div className="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e3a31e62979bf147c9">
                  <div className="card h-100 border-0 shadow">
                      ...
                      <div className="card-img-overlay-bottom z-index-20">
                                    <div className="media text-white text-sm align-items-center"><img className="avatar avatar-border-white mr-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-8.jpg"} alt="Julie" />
                ...
                {/* place item*/}
                <div className="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e3503eb77d487e8082">
                  <div className="card h-100 border-0 shadow">
                      ...
                      <div className="card-img-overlay-bottom z-index-20">
                                    <div className="media text-white text-sm align-items-center"><img className="avatar avatar-border-white mr-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-9.jpg"} alt="Barbora" />
                ...
                {/* place item*/}
                <div className="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e39aa2eed0626e485d">
                  <div className="card h-100 border-0 shadow">
                      ...
                      <div className="card-img-overlay-bottom z-index-20">
                                    <div className="media text-white text-sm align-items-center"><img className="avatar avatar-border-white mr-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-10.jpg"} alt="Jack" />
                ...
                {/* place item*/}
                <div className="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e39aa2edasd626e485d">
                  <div className="card h-100 border-0 shadow">
                      ...
                      <div className="card-img-overlay-bottom z-index-20">
                                    <div className="media text-white text-sm align-items-center"><img className="avatar avatar-border-white mr-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-11.jpg"} alt="Stuart" />
            ...
            <div className="text-block">
              ...
              <div className="media d-block d-sm-flex review">
                            <div className="text-md-center mr-4 mr-xl-5"><img className="d-block avatar avatar-xl p-2 mb-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-8.jpg"} alt="Padmé Amidala" /><span className="text-uppercase text-muted text-sm">Dec 2018</span></div>
                <div className="media-body">
              ...
              <div className="media d-block d-sm-flex review">
                            <div className="text-md-center mr-4 mr-xl-5"><img className="d-block avatar avatar-xl p-2 mb-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-2.jpg"} alt="Luke Skywalker" /><span className="text-uppercase text-muted text-sm">Dec 2018</span></div>
                <div className="media-body">
              ...
              <div className="media d-block d-sm-flex review">
                            <div className="text-md-center mr-4 mr-xl-5"><img className="d-block avatar avatar-xl p-2 mb-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-3.jpg"} alt="Princess Leia" /><span className="text-uppercase text-muted text-sm">Dec 2018</span></div>
                <div className="media-body">
              ...
              <div className="media d-block d-sm-flex review">
                            <div className="text-md-center mr-4 mr-xl-5"><img className="d-block avatar avatar-xl p-2 mb-2" src={process.env.PUBLIC_URL + "assets/img/avatar/avatar-4.jpg"} alt="Jabba Hut" /><span className="text-uppercase text-muted text-sm">Dec 2018</span></div>
                <div className="media-body">
