      ...
      <div className="col-lg-7">
        <div className="text-block"> 
          <div className="row mb-3">
            ...
            <div className="col-sm-3 text-right">
              <button className="btn btn-link pl-0 text-primary collapsed" type="button" data-toggle="collapse" data-target="#personalDetails" aria-expanded="false" aria-controls="personalDetails">Update</button>
            </div>
          </div>
          <p className="text-sm text-muted"><i className="fa fa-id-card fa-fw mr-2" />John Doe<br /><i className="fa fa-birthday-cake fa-fw mr-2" />06/22/1980<br /><i className="fa fa-envelope-open fa-fw mr-2" />john.doe@directory.com  <span className="mx-2"> | </span>  <i className="fa fa-phone fa-fw mr-2" />+42055544466</p>
          <div className="collapse" id="personalDetails">
            <form action="#">
              <div className="row pt-4">
                <div className="form-group col-md-6">
                  <label className="form-label" htmlFor="name">Name</label>
                  <input className="form-control" type="text" name="name" id="name" defaultValue="John Doe" />
                </div>
                <div className="form-group col-md-6">
                  <label className="form-label" htmlFor="date">Date of birth</label>
                  <input className="form-control" type="text" name="date" id="date" defaultValue="06/22/1980" />
                </div>
                <div className="form-group col-md-6">
                  <label className="form-label" htmlFor="email">Email address</label>
                  <input className="form-control" type="email" name="email" id="email" defaultValue="john.doe@directory.com" />
                </div>
                <div className="form-group col-md-6">
                  <label className="form-label" htmlFor="phone">Phone number</label>
                  <input className="form-control" type="text" name="phone" id="phone" defaultValue={+42055544466} />
                </div>
              </div>
        ...
        <div className="text-block"> 
          <div className="row mb-3">
            ...
            <div className="col-sm-3 text-right">
              <button className="btn btn-link pl-0 text-primary collapsed" type="button" data-toggle="collapse" data-target="#address" aria-expanded="false" aria-controls="address">Change</button>
            </div>
          </div>
          <div className="media text-sm text-muted"> <i className="fa fa-address-book fa-fw mr-2" />
            <div className="media-body mt-n1">123 Main St., Apt #7<br />San Francisco, CA, 902 10</div>
          </div>
            ...
            <form action="#">
              <div className="row pt-4">
                <div className="form-group col-md-6">
                  ...
                  <input className="form-control" type="text" name="street" id="street" defaultValue="123 Main St." />
                </div>
                <div className="form-group col-md-6">
                  <label className="form-label" htmlFor="apt">Apt. (optional)</label>
                  <input className="form-control" type="text" name="apt" id="apt" defaultValue="Apt #7" />
                </div>
                <div className="form-group col-md-6">
                  <label className="form-label" htmlFor="city">City</label>
                  <input className="form-control" type="text" name="city" id="city" defaultValue="San Francisco" />
                </div>
                <div className="form-group col-md-6">
                ...
                <div className="form-group col-md-6">
                  ...
                  <input className="form-control" type="text" name="zip" id="zip" defaultValue="902 10" />
                </div>
              </div>
